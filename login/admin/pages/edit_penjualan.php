                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <form action="" method="POST" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="jumlah_jual" value="<?php echo $data['jumlah_jual'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Jual</label>
                                            <input class="form-control" type="date" name="tanggal_jual" value="$data['nama_member']">
                                        </div>
                            ...
                            <?php
                                if (isset($_POST['edit'])) {
                                    $query = mysqli_query($koneksi,"UPDATE penjualan 
                                        set id_penjualan='', 
